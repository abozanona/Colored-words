(function (libblueGREEN, img, cjs, ss) {

var p; // shortcut to reference prototypes

// libblueGREENrary properties:
libblueGREEN.properties = {
	width: 80,
	height: 110,
	fps: 24,
	color: "#FFFFFF",
...
(libblueGREEN.Tween1_1 = function() {
	this.initialize();
...
(libblueGREEN.Path_1_1 = function() {
	this.initialize();
...
(libblueGREEN.Tween3 = function() {
	this.initialize();

	// Layer 1
	this.instance = new libblueGREEN.Path_2();
	this.instance.setTransform(8.2,-10.6,1,1,0,0,0,10.6,8.8);
	this.instance.alpha = 0.602;

	this.instance_1 = new libblueGREEN.Path_1_1();
...
(libblueGREEN.Tween2 = function() {
	this.initialize();

	// Layer 1
	this.instance = new libblueGREEN.Path();
	this.instance.setTransform(4.9,-9.2,1,1,0,0,0,8.3,5.7);
	this.instance.alpha = 0.602;

	this.instance_1 = new libblueGREEN.Path_1();
...
// stage content:
(libblueGREEN.blueGREEN = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 3
	this.instance = new libblueGREEN.Tween3("synched",0);
	...
	// Layer 1
	this.instance_1 = new libblueGREEN.Tween1_1("synched",0);
	...
	// Layer 3
	this.instance_2 = new libblueGREEN.Tween2("synched",0);
	...
	// Layer 4
	this.instance_3 = new libblueGREEN.Tween4("synched",0);
	...
	// Layer 1
	this.instance_4 = new libblueGREEN.Tween1("synched",0);
...
})(libblueGREEN = libblueGREEN||{}, images = images||{}, createjs = createjs||{}, ss = ss||{});
var libblueGREEN, images, createjs, ss;