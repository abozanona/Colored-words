(function (libmagintabaloon, img, cjs, ss) {

var p; // shortcut to reference prototypes

// libmagintabaloonrary properties:
libmagintabaloon.properties = {
	width: 90,
	height: 180,
	fps: 24,
	color: "#FFFFFF",
...
(libmagintabaloon.Path_1 = function() {
	this.initialize();

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#BC3187","rgba(239,156,227,0.2)"],[0,0.996],-6.7,-25.3,4.1,13.7).s().p("AhdBxQgfiHAxhoQAdg9A1g0QAygwANAJQACABAAASQgBAVAIAPQAJARASANQg/AfgkA4QgtBLAQBiQAJA2ASAnQgXARgMAdQgJAXADAZQACAPAFAMQgthUgThUg");
...
(libmagintabaloon.Path = function() {
	this.initialize();

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(188,49,135,0)","#C951B0"],[0,0.996],9.1,-9.7,-7.8,8.3).s().p("AB/B+QgZgDgaAHQgGg4gfgrQgfgpgsgQQgogNgvALQgZgQgJgaQgIgWAEgMQANggBOACQBPACAYAqQAGAKAAAMIAAAWQABBWB7BfQgRgHgTgCg");
...
(libmagintabaloon.Tween1 = function() {
	this.initialize();

	// Layer 1
	this.instance = new libmagintabaloon.Path();
	this.instance.setTransform(17,-43.2,0.981,0.981,10,0,0,16.1,13.8);
	this.instance.alpha = 0.602;

	this.instance_1 = new libmagintabaloon.Path_1();
	this.instance_1.setTransform(-16.2,-30.3,0.981,0.981,10,0,0,10.5,28.1);
	this.instance_1.alpha = 0.5;

	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#EC008C","#F40087"],[0,0.996],9.8,-33.7,-10.5,24.7).s().p("AghGlQgSgCgTgEQgYgGgBgGQgCgKAYgLQiDhNg+h/Qg2huAEh6QAEiMBShhQApgwAyghQBfg9BdAPQCNAWBYCwQAkBLADBRQAECaiACLQhFBLhJApQgpAYgrAQIAFAIQAGAJAHAJQAFAFAAACQgBAEgMAAIgKgBg");
	this.shape.setTransform(0.5,-21,0.981,0.981,10);
...
// stage content:
(libmagintabaloon.magintabaloon = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new libmagintabaloon.Tween1("synched",0);
...
p.nominalBounds = new cjs.Rectangle(50.3,106.4,76,160.9);

})(libmagintabaloon = libmagintabaloon||{}, images = images||{}, createjs = createjs||{}, ss = ss||{});
var libmagintabaloon, images, createjs, ss;