(function (libBLUEbaloon, img, cjs, ss) {

var p; // shortcut to reference prototypes

// libBLUEbaloonrary properties:
libBLUEbaloon.properties = {
	width: 90,
	height: 180,
	fps: 24,
	color: "#FFFFFF",
...
(libBLUEbaloon.Tween1 = function() {
	this.initialize();

	// Layer 1
	this.instance = new libBLUEbaloon.Path();
	this.instance.setTransform(17.7,-44.4,2.107,2.107,17.7,0,0,8.9,5.5);
	this.instance.alpha = 0.602;

	this.instance_1 = new libBLUEbaloon.Path_1();
...
// stage content:
(libBLUEbaloon.BLUEbaloon = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new libBLUEbaloon.Tween1("synched",0);
...
p.nominalBounds = new cjs.Rectangle(50.3,106,76.2,161.3);

})(libBLUEbaloon = libBLUEbaloon||{}, images = images||{}, createjs = createjs||{}, ss = ss||{});
var libBLUEbaloon, images, createjs, ss;