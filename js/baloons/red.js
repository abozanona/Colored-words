(function (libredbaloon, img, cjs, ss) {

var p; // shortcut to reference prototypes

// libredbaloonrary properties:
libredbaloon.properties = {
	width: 90,
	height: 180,
	fps: 24,
	color: "#FFFFFF",
...
(libredbaloon.Path_1 = function() {
	this.initialize();

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#D82E2E","rgba(229,158,158,0.2)"],[0,0.996],-6.7,-25.3,4.1,13.7).s().p("AhdBxQgfiHAxhoQAdg9A1g0QAygwANAJQACABAAASQgBAVAIAPQAJARASANQg/AfgkA4QgtBLAQBiQAJA2ASAnQgXARgMAdQgJAXADAZQACAPAFAMQgthUgThUg");
...
(libredbaloon.Path = function() {
	this.initialize();

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(196,0,0,0)","#EF9E9E"],[0,0.996],9.1,-9.7,-7.8,8.3).s().p("AB/B+QgZgDgaAHQgGg4gfgrQgfgpgsgQQgogNgvALQgZgQgJgaQgIgWAEgMQANggBOACQBPACAYAqQAGAKAAAMIAAAWQABBWB7BfQgRgHgTgCg");
...
(libredbaloon.Tween1 = function() {
	this.initialize();

	// Layer 1
	this.instance = new libredbaloon.Path();
	this.instance.setTransform(18.1,-42.4,0.985,0.985,11,0,0,16.3,14);
	this.instance.alpha = 0.398;

	this.instance_1 = new libredbaloon.Path_1();
	this.instance_1.setTransform(-14.8,-28.9,0.985,0.985,11,0,0,10.7,28.9);
	this.instance_1.alpha = 0.5;

	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FF0000","#C40000"],[0,0.996],9.8,-33.7,-10.5,24.7).s().p("AghGlQgSgCgTgEQgYgGgBgGQgCgKAYgLQiDhNg+h/Qg2huAEh6QAEiMBShhQApgwAyghQBfg9BdAPQCNAWBYCwQAkBLADBRQAECaiACLQhFBLhJApQgpAYgrAQIAFAIQAGAJAHAJQAFAFAAACQgBAEgMAAIgKgBg");
	this.shape.setTransform(0.9,-21,0.985,0.985,11);

	this.addChild(this.shape,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-30.3,-62,67.1,81.5);


// stage content:
(libredbaloon.redbaloon = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new libredbaloon.Tween1("synched",0);
...
p.nominalBounds = new cjs.Rectangle(50.9,106,76.3,161.3);

})(libredbaloon = libredbaloon||{}, images = images||{}, createjs = createjs||{}, ss = ss||{});
var libredbaloon, images, createjs, ss;