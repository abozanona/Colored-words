(function (libblackbaloon, img, cjs, ss) {

var p; // shortcut to reference prototypes

// libblackbaloonrary properties:
libblackbaloon.properties = {
	width: 90,
	height: 180,
	fps: 24,
	color: "#FFFFFF",
...
(libblackbaloon.Path_1 = function() {
	this.initialize();

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(183,183,183,0.2)"],[0,0.996],-6.7,-25.3,4.1,13.7).s().p("AhdBxQgfiHAxhoQAdg9A1g0QAygwANAJQACABAAASQgBAVAIAPQAJARASANQg/AfgkA4QgtBLAQBiQAJA2ASAnQgXARgMAdQgJAXADAZQACAPAFAMQgthUgThUg");
...
(libblackbaloon.Path = function() {
	this.initialize();

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(0,0,0,0)","#9B9B9B"],[0,0.996],9.1,-9.7,-7.8,8.3).s().p("AB/B+QgZgDgaAHQgGg4gfgrQgfgpgsgQQgogNgvALQgZgQgJgaQgIgWAEgMQANggBOACQBPACAYAqQAGAKAAAMIAAAWQABBWB7BfQgRgHgTgCg");
...
(libblackbaloon.Tween1 = function() {
	this.initialize();

	// Layer 1
	this.instance = new libblackbaloon.Path();
	this.instance.setTransform(17,-42.3,0.98,0.98,10,0,0,16.4,13.8);
	this.instance.alpha = 0.398;

	this.instance_1 = new libblackbaloon.Path_1();
	this.instance_1.setTransform(-16.5,-29.5,0.98,0.98,10,0,0,10.8,28.1);
	this.instance_1.alpha = 0.5;

	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#2D2D2D","#000000"],[0,0.996],9.8,-33.7,-10.5,24.7).s().p("AghGlQgSgCgTgEQgYgGgBgGQgCgKAYgLQiDhNg+h/Qg2huAEh6QAEiMBShhQApgwAyghQBfg9BdAPQCNAWBYCwQAkBLADBRQAECaiACLQhFBLhJApQgpAYgrAQIAFAIQAGAJAHAJQAFAFAAACQgBAEgMAAIgKgBg");
	this.shape.setTransform(0.7,-21,0.98,0.98,10);

	this.addChild(this.shape,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-31.7,-61.8,66.9,81.3);


// stage content:
(libblackbaloon.blackbaloon = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new libblackbaloon.Tween1("synched",0);
...
p.nominalBounds = new cjs.Rectangle(50.6,106.5,75.9,160.8);

})(libblackbaloon = libblackbaloon||{}, images = images||{}, createjs = createjs||{}, ss = ss||{});
var libblackbaloon, images, createjs, ss;